...
def create_file_handler(
    ...
    handler = FilePathHander(input_folder_path)
...
def create_file_handler_20210915(
        input_folder_path,
        search_level,
        path_keep_keyword,
        path_remove_keyword,
...
def create_export_image_url_handler(
    input_folder_path,
    ...
    handler = FilePathHander(input_folder_path)
    handler.input_folder_path = input_folder_path
    handler.path_remoeve_keywords = path_remoeve_keywords
    handler.path_keep_keywords = path_keep_keywords
    handler.replace_remove = replace_remove
    handler.replace_add = replace_add
    handler.export_file_path = export_file_path
...
class FilePathHander:
    def __init__(self, input_folder_path) -> None:
        ...
        self.direct_list = [self.input_folder_path]
        self.file_name_list = []
        self.file_path_list = []
